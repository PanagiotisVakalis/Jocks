...
//		super.getClient().useChangePanel(new IntroView(introModel));
	...
	/**
	 * Method to clear the fields of the register form
	 * by changing panel to registerView
	 * @param registerView
	 * 
	 * @author Panagiotis Vakalis
	 * @version 14-07-2015
	 ...
	 * @return Register succesfull, your portfolio is created, if register is succesfull
	 ...
	 * @version 14-07-2015
	 */
	private String registerUser(String email, String password, String password2, String firstName, String lastName, String securityQuestion, String securityAnswer){
		/*
		 * Since method getText() returns an empty String if the 
		 * JTextField is null instead of null value this if statement
		 * checks if the String is empty
		 */
		if(!email.equals("") && !password.equals("") && !password2.equals("") && !firstName.equals("") && !lastName.equals("") && !securityQuestion.equals("") && !securityAnswer.equals("")){
			if(validEmail(email)){
...
//							Database.useRegisterInvestor(email, password, firstName, lastName, securityQuestion, securityAnswer);
							 ...
							 * automatically every time that a new investor
							 * is registered the following method will be used in
...
//						return "Password does not match";
	 ...
	 * @version 14-07-2015
	 */
	public String useRegisterUser(String email, String password, String password2, String firstName, String lastName, String securityQuestion, String securityAnswer){
		return registerUser(email, password, password2, firstName, lastName, securityQuestion, securityAnswer);
	}
	...
	/**
	 * Method to create the first portfolio of an investor

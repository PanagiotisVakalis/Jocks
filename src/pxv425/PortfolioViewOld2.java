...
public class PortfolioViewOld2 extends View implements ActionListener, ItemListener, Observer {
	...
	private JPanel historyInformationPanel;
...
//	private JPanel totalDepositsPanel;
	 ...
	 * @version 18-07-2015
	 */
	public PortfolioViewOld2(PortfolioModel portfolioModel) {
...
//		initialBalancePanel = new JPanel(new GridLayout(1, 1));
...
//		portfolioInformationPanel.add(totalReturnPanel);
		...
		historyInformationPanel = new JPanel(new GridLayout(3, 3));
		historyInformationPanel.add(initialBalance, LEFT_ALIGNMENT);
		historyInformationPanel.add(initialBalanceArea, RIGHT_ALIGNMENT);
		historyInformationPanel.add(totalWithdraws, LEFT_ALIGNMENT);
		historyInformationPanel.add(totalWithdrawsArea, RIGHT_ALIGNMENT);
		historyInformationPanel.add(totalDeposits, LEFT_ALIGNMENT);
		historyInformationPanel.add(totalDepositsArea, RIGHT_ALIGNMENT);
		
		//Current information panel
		currentInformationPanel = new JPanel(new GridLayout(3, 3));
		currentInformationPanel.add(balanceNow, LEFT_ALIGNMENT);
		currentInformationPanel.add(balanceNowArea, RIGHT_ALIGNMENT);
		currentInformationPanel.add(investedMoney, LEFT_ALIGNMENT);
		currentInformationPanel.add(investedMoneyArea, RIGHT_ALIGNMENT);
		currentInformationPanel.add(profitLossLots, LEFT_ALIGNMENT);
		currentInformationPanel.add(profitLossLotsArea, RIGHT_ALIGNMENT);
		
		portfolioInformationPanel = new JPanel(new GridLayout(1, 1));
		portfolioInformationPanel.add(historyInformationPanel, LEFT_ALIGNMENT);
		portfolioInformationPanel.add(currentInformationPanel, RIGHT_ALIGNMENT);

...
public class WatchlistModel extends Model {
	...
	private String[][] watchesDetails() {
		...
		for (int i = 0; i < watches.size(); i++) {
			...
			watchesDetails[i][2] = View.currencyFormat(new BigDecimal(watches
					.get(i).getPrice()));
		}
	 ...
	 * @version 26-07-2015
	 */
	private void changeToBuyView(BuyView buyView, Portfolio portfolio,
			Stock stock) {
	 ...
	 * @version 26-07-2015
	 */
	public void useChangeToBuyView(BuyView buyView, Portfolio portfolio,
			Stock stock) {

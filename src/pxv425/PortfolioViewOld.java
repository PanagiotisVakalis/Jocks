 ...
 * @version 18-07-2015
 */
public class PortfolioViewOld extends View implements ActionListener, Observer {
	 ...
	 * @version 18-07-2015
	 */
	public PortfolioViewOld(PortfolioModel portfolioModel) {
		...
		frameSetup();
		Database.useUpdateLotsWithCurrentPrice(PortfolioViewOld.getPortfolioSelection().getNumber());
	}

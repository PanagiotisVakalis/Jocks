...
/**
 * Class which is used in order to send an email
 * This JavaMail API has been used
 * 
...
public class Email {
	 ...
	 * @version 29-07-2015
	 */
	public Email(String investorFirstName, String investorLastName, String investorEmail){
	...
	private void sendEmail(String body){
		...
		try{
			...
			message.setSubject("Investor: " + investorFirstName + " " + investorLastName + " needs help");

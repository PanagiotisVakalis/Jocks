...
public class ChangePasswordModelTesting {
	...
	public void useChangePasswordTest1(){
		...
		ChangePasswordModel changePasswordModel = new ChangePasswordModel(client);
		...
		String result = changePasswordModel.useChangePassword(email, securityAnswer, newPassword, reEnterNewPassword);

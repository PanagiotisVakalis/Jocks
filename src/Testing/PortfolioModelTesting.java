...
public class PortfolioModelTesting {
	...
	public void useDepositTest1(){
		...
		String result = View.currencyFormat(portfolioModel.useGetBalanceNow(41));
	...
	public void retrieveTotalReturnTest(){
		/*
		 * I have changed the values in database.
		 * I did the following:
		...
		String result = portfolioModel.retrieveTotalReturn(portfolio.getNumber());

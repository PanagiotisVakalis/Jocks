...
public class SellModelTesting {
	...
	public void useUpdateBalanceNowAndNewInvestedMoneyTest1() {
		...
		ArrayList<Lot> lots = Database
				.useGetLotsForASpecificPortfolio(portfolio.getNumber());
		Lot lot = lots.get(0);
		...
		sellModel.useUpdateNewBalanceAndNewInvestedMoney(
				sellModel.getStockPrice(), sellView.getShares());
	...
	public void useSellStocTest4() {
		...
		String expected = "You have sold " + sellView.getShares() + " of "
				+ sellModel.getStockName() + " stock.";
		String result = sellModel.useSellStock(sellView.getShares());

...
public class BuyModelTesting {
	...
	public void useUpdateBalanceNowAndNewInvestedMoneyTest1() {
		...
		ArrayList<Portfolio> portfolios = Database
				.useGetInvestorPortfolioNumber(investor.getId());
		...
		buyModel.useUpdateNewBalanceAndNewInvestedMoney(
				...
				new BigInteger((String.valueOf(buyView.getShares()))));

		BigDecimal expectedBalance = new BigDecimal(929.50).setScale(2,
				BigDecimal.ROUND_DOWN);
		BigDecimal expectedInvestedMoney = new BigDecimal(6056.17).setScale(2,
				BigDecimal.ROUND_DOWN);
	...
	public void useBuyStockTest4() {
		...
		String expected = "You have bought " + buyView.getShares() + " of "
				+ stock.getName() + " stock.";
		String result = buyModel.useBuyStock(buyView.getShares());
